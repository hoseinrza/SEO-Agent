...
### اسکیما را با معیار بسنج، نه با حضور/غیاب

وقتی structured data را audit می‌کنی، معیارها در `docs/schema-guide.md` است: نوع درست
برای نوع صفحه، فیلدهای لازم، و مهم‌تر از همه **آیا اسکیما همان چیزی را می‌گوید که کاربر
روی صفحه می‌بیند**. اسکیمای دروغ (rating بدون نظر، FAQ بدون متن) ریسک جریمه است و باید
`Critical` گزارش شود، نه یک بهبود اختیاری.
